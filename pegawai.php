              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    ...
                    <?php
                    $SQL = "SELECT * FROM data_user WHERE hak_akses='Staff' or hak_akses='Kabid'";
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/akta_kelahiran/">BATAL</a>
                </div>
