...
$pdf->Cell(125);
$pdf->Cell(30, 7, 'Laporan Akta Pengesahan Anak', 0, 1, 'C');
...
$pdf->Cell(30, 6, 'NO. AKTA', 1, 0, 'C');
$pdf->Cell(40, 6, 'NAMA ANAK', 1, 0, 'C');
$pdf->Cell(27, 6, 'TTL', 1, 0, 'C');
$pdf->Cell(50, 6, 'NAMA AYAH', 1, 0, 'C');
$pdf->Cell(50, 6, 'NAMA IBU', 1, 0, 'C');
$pdf->Cell(50, 6, 'TANGGAL PEMBERKATAN', 1, 1, 'C');

$pdf->SetFont('Arial', '', 10);

include '../konek.php';
$no = 1;
$tampil = "SELECT * FROM data_pengesahan_anak, data_akta_kelahiran
WHERE data_pengesahan_anak.id_akta_kelahiran = data_akta_kelahiran.id_akta_kelahiran";
...
while ($data = mysqli_fetch_array($query, MYSQLI_BOTH)) {
    ...
    $pdf->Cell(30, 6, $data['id_akta_kelahiran'], 1, 0);
    $pdf->Cell(40, 6, $data['nama'], 1, 0);
    $pdf->Cell(27, 6, $data['tanggal_lahir'], 1, 0);
    $pdf->Cell(50, 6, $data['nama_ayah'], 1, 0);
    $pdf->Cell(50, 6, $data['nama_ibu'], 1, 0);
    $pdf->Cell(50, 6, $data['tanggal_pemberkatan'], 1, 1);
}
