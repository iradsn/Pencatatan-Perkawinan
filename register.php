          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <center> <img src="main/img/2.png" alt="logo"> </center>
              </div>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="form-group">
                  <input type="text" name="nama" class="form-control form-control-lg" placeholder="Nama Lengkap Anda.." required onkeyup="this.value = this.value.toUpperCase()">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" name="kota" class="form-control form-control-lg" placeholder="Kota Lahir Anda.." required onkeyup="this.value = this.value.toUpperCase()">
                </div>
                <div class="form-group">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/akta1/">BATAL</a>
                </div>
