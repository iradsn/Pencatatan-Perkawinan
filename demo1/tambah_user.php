...
if (isset($_POST['simpan'])) {
	...
	$sql = "INSERT INTO data_user (nik,password,hak_akses,nama,jekel,tempat_lahir,tanggal_lahir,status_warga,alamat) VALUES ('$nik','$password','$hak_akses','$nama','$jekel','$tempat_lahir','$tanggal_lahir','$status_warga','$alamat')";
