...
if (isset($_POST['kirim'])) {
	...
	$suratnikahTmpName = ['suratnikah']['tmp_name'];
	move_uploaded_file($suratnikahTmpName, "../dataFoto/suratnikah/" . $suratnikah);
	...
	$sql = "INSERT INTO data_request_akta (nik,ktpistri,kksuami,aktaistri,kkistri,aktasuami,ktpsuami,suratnikah,niksuami,nikistri,namasuami,namaistri,tempat,tanggal,bulan,tahun,nama_pemuka_agama) VALUES ('$nik','$file_ktpistri','$file_kksuami','$file_aktaistri','$file_kkistri','$file_aktasuami','$file_ktpsuami','$suratnikah','$niksuami','$nikistri','$namasuami','$namaistri','$tempat','$tanggal','$bulan','$tahun','$nama_pemuka_agama')";
