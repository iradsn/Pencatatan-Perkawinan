                ...
                <div class="card-body">
                    <div class="card-tools">
                        ...
                        if (isset($_POST['ttd'])) {
                            ...
                            if ($update) {
                                echo "<script language='javascript'>swal('Selamat...', 'ACC Kepala Bidang Pencatatan Sipil Berhasil', 'success');</script>";
                                echo '<meta http-equiv="refresh" content="3; url=?halaman=belum_acc_akta">';
                            } else {
                                echo "<script language='javascript'>swal('Gagal...', 'ACC Kepala Bidang Pencatatan Sipil Gagal', 'error');</script>";
