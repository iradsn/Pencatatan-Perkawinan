...
?>
	...
	<div class="page-inner">
		<!-- Card -->
		<h3 class="fw-bold text-uppercase">TAMPIL PERMOHONAN PENCATATAN PERKAWINAN</h3>
					...
					<div class="card-body ">
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-5 ml-sm-0">
								<div class="numbers">
									<p class="card-category">PENCATATAN PERKAWINAN</p>
									<?php
...
?>
	...
	<div class="page-inner">
		<!-- Card -->
		<h4 class="page-title">TAMPIL PENCATATAN PERKAWINAN SUDAH ACC STAF</h4>
		<!-- Card With Icon States Background -->
		<div class="row">
			<div class="col-sm-6 col-md-5">
				<div class="card card-stats card-round">
					<div class="card-body ">
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									<p class="card-category">PENCATATAN AKTA PERKAWINAN</p>
									<?php
