...
$pdf->Cell(125);
$pdf->Cell(30, 7, 'Laporan Pending Pencatatan Perkawinan', 0, 1, 'C');
...
$pdf->Cell(75, 6, 'MEMPELAI PRIA', 1, 0, 'C');
$pdf->Cell(90, 6, 'MEMPELAI WANITA', 1, 0, 'C');
...
while ($data = mysqli_fetch_array($query, MYSQLI_BOTH)) {
    ...
    $pdf->Cell(7, 6, $no++, 1, 0, 'C');
    $pdf->Cell(75, 6, $data['mempelai_pria'], 1, 0);
    $pdf->Cell(90, 6, $data['mempelai_wanita'], 1, 0);
