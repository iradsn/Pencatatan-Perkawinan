...
$pdf->Cell(125);
$pdf->Cell(30, 7, 'Laporan Akta Perceraian', 0, 1, 'C');
...
$pdf->Cell(50, 6, 'TANGGAL PERKAWINAN', 1, 0, 'C');
$pdf->Cell(50, 6, 'TANGGAL PERCERAIAN', 1, 1, 'C');
...
while ($data = mysqli_fetch_array($query, MYSQLI_BOTH)) {
    ...
    $pdf->Cell(50, 6, $data['tanggal_perkawinan'], 1, 0);
    $pdf->Cell(50, 6, $data['tanggal_cerai'], 1, 1);
}
